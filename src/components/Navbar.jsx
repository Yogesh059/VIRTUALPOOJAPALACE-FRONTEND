    ...
    <Container>
      <Wrapper>
        <Left>
          ...
          <div>
          <Link to ="/">
          <img src={home} class="logo" style={{ height: '40px', width: 'auto', display: 'block' }}/>
          </Link>
          </div>
         
        </Left>
        <Center>
          <Logo>VirtualPoojaPalace</Logo>
        </Center>
        <Right>
          {data ? <ShoppingBasket style={{ cursor: "pointer" }} onClick={handleOrder} /> : <Logo>VBC</Logo>}
